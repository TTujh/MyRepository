...
MV_CODEREADER_GVSP_PIX_MONO = 0x01000000
MV_CODEREADER_GVSP_PIX_RGB = 0x02000000
MV_CODEREADER_GVSP_PIX_COLOR = 0x02000000
MV_CODEREADER_GVSP_PIX_CUSTOM = 0x80000000
MV_CODEREADER_GVSP_PIX_COLOR_MASK = 0xFF000000

MV_CODEREADER_GVSP_PIX_EFFECTIVE_PIXEL_SIZE_MASK = 0x00FF0000
MV_CODEREADER_GVSP_PIX_EFFECTIVE_PIXEL_SIZE_SHIFT = 16

# Pixel ID: lower 16-bit of the pixel formats
MV_CODEREADER_GVSP_PIX_ID_MASK = 0x0000FFFF
MV_CODEREADER_GVSP_PIX_COUNT = 0x46

PixelType_CodeReader_Gvsp_Undefined = 0xFFFFFFFF  # if WIN32, else -1


def MV_CODEREADER_PIXEL_BIT_COUNT(n):
    return n << 16
